...
class SettingsActivity : SimpleActivity() {
    ...
    private fun setupThemes() {
        binding.apply {
            val activeTheme = org.fossify.keyboard.helpers.ThemeEngine.getActiveTheme(this@SettingsActivity)
            settingsThemesValue.text = activeTheme.name
            settingsThemesHolder.setOnClickListener {
                Intent(this@SettingsActivity, ThemesActivity::class.java).apply {
                    startActivity(this)
                }
            }
        }
    ...
    private fun setupCustomLayouts() {
        binding.apply {
            val activeLayoutId = org.fossify.keyboard.helpers.CustomLayoutManager.getActiveLayoutId(this@SettingsActivity)
            if (activeLayoutId != null) {
                val layout = org.fossify.keyboard.helpers.CustomLayoutManager.getLayoutById(this@SettingsActivity, activeLayoutId)
                settingsCustomLayoutsValue.text = layout?.name ?: getString(R.string.custom_layouts_summary)
            } else {
                settingsCustomLayoutsValue.text = getString(R.string.custom_layouts_summary)
            }
            settingsCustomLayoutsHolder.setOnClickListener {
                Intent(this@SettingsActivity, LayoutsActivity::class.java).apply {
                    startActivity(this)
                }
            }
        }
    ...
    private fun setupSmartAutoCorrection() {
        binding.apply {
            settingsSmartAutoCorrection.isChecked = config.smartAutoCorrection
            settingsSmartAutoCorrectionHolder.setOnClickListener {
                settingsSmartAutoCorrection.toggle()
                config.smartAutoCorrection = settingsSmartAutoCorrection.isChecked
            }
        }
    }
